...
const GameManager = {
  ...
  toNextPhase: function () {
    ...
    const levelCompleteTxt = game.add
      .text(game.world.centerX, 150, 'Nivel Completo', {
        font: '20px emulogic',
        fill: '#fff'
      });
    ...
    score.gameScoreTxt.text = 'Pontos: ' + formatDisplayNumbers(game.global.score);
    ...
    const bonusTxt = game.add
      .text(game.world.centerX, 200, 
        'Tempo Bonus: ' + formatDisplayNumbers(bonus), {
        font: '15px emulogic',
        fill: '#fff'
      });
    ...
    const finalScoreTxt = game.add
      .text(game.world.centerX, 300, 
        'Pontos Finais: ' + formatDisplayNumbers(game.global.score), {
        font: '30px emulogic',
        fill: '#fff'
      });
  ...
  gameOver: function () {
    ...
    const bestScoreTxt = game.add
      .text(game.world.centerX, 350, 
        'Melhores Pontos: ' + formatDisplayNumbers(game.global.highScore), {
        font: '30px emulogic',
        fill: '#fff'
      });
...
const score = {
  ...
  coinScore: function () {
    ...
    this.coinScoreTxt = game.add
      .text(15, 15, `Moedas: ${coins.total} / ${coins.max}`, {
  ...
  gameScore: function () {
    this.gameScoreTxt = game.add
      .text(game.world.centerX, 15, 'Pontos: ' 
...
const timer = {
  create: function (time) {
    ...
    this.timerTxt = game.add
      .text(game.world.width - 15, 15, 'Tempo: ' + formatDisplayNumbers(this.time), {
        font: '15px emulogic',
        fill: '#fff'
      });
  ...
  start: function () {
    ...
    this.timer = game.time.events.loop(1000, function () {
      this.time--;
      this.timerTxt.text = 'Tempo: ' + formatDisplayNumbers(this.time);
    }, this);
  },
